...
public class ImmutableLinkedListTest {
    ...
    public void testAdd() {
        ...
        linkedList = mainLinkedList.add(2, 120);

        assertEquals(linkedList.get(2), 120);

        assertEquals(mainLinkedList.get(2), 2);

        linkedList = mainLinkedList.addAll(1, array);
    ...
    public void testAddWithError(){
        linkedList = mainLinkedList.add(4, 5);
    }

    @Test
    public void testRemove() {
        linkedList = mainLinkedList.remove(1);
    ...
    public void testRemoveWithException() {
        linkedList = mainLinkedList.remove(3);
    }

    @Test
    public void testGetSetIndex() {
        linkedList = mainLinkedList.set(1, 150);
        assertEquals(linkedList.get(1), 150);

        assertEquals(linkedList.indexOf(150), 1);
    ...
    public void testGetSetIndexWithException() {
        linkedList = mainLinkedList.set(3, 150);
    }

    @Test
    public void testEmptyClear() {
        linkedList = mainLinkedList.clear();
